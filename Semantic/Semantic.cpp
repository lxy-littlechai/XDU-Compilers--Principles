...
double Semantic::getExpressionValue(const std::shared_ptr<TreeNode> &root) {
    switch (root->tokenType) {
        case TokenType::PLUS: {
            return getExpressionValue(root->operatorNode.Lchild) + getExpressionValue(root->operatorNode.Rchild);
        }
        ...
        case TokenType::POWER: {
            return pow(getExpressionValue(root->operatorNode.Lchild), getExpressionValue(root->operatorNode.Rchild));
        }
        case TokenType::FUNC: {
